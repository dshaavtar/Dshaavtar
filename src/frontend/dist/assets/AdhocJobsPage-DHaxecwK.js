import { r as reactExports, j as jsxRuntimeExports, cG as useAdhocJobCategories, i as useAdhocJobStats, cH as useAdhocJobs, cI as JobType, cJ as useCreateAdhocJob, cK as useListAdhocJobsAdmin, c2 as useUpdateAdhocJobStatusAdmin, c3 as useDeleteAdhocJobAdmin, p as ue, c1 as useCreateAdhocJobAdmin } from "./index-D4mmtgjo.js";
...
import { G as GraduationCap } from "./graduation-cap-Cx6R87lg.js";
...
function useCountdown(expiresAt) {
  ...
  reactExports.useEffect(() => {
    const id2 = setInterval(() => tick((n) => n + 1), 6e4);
    return () => clearInterval(id2);
  }, []);
  if (!expiresAt) return null;
  const diff = Number(expiresAt) / 1e6 - Date.now();
...
function PostJobModal({ open, onClose, categories }) {
  ...
  async function handleSubmit() {
    try {
      ...
      ue.error(`Failed to post job: ${String(err)}`);
    }
  }
    ...
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { id: "post-job-desc", className: "sr-only", children: [
            "Post a new daily job in ",
            STEPS.length,
            " steps"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: STEPS.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-[120px]", children: [
          step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "pj-title", children: "Job Title" }),
          ...
          step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "post-job.category.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select category…" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "max-h-56 overflow-y-auto", children: categories.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c, children: c }, c)) })
                ]
              }
            )
          ] }),
          step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "pj-price", children: "Price per day (₹)" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: [
                ...
                "button",
                {
                  ...
                  className: [
                    ...
                    form.jobType === val ? "border-primary bg-primary/10 text-primary font-medium" : "border-input text-muted-foreground hover:border-primary/50"
                  ].join(" "),
                  children: label
                },
                val
          ...
          step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Education Requirement" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "post-job.education.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: EDUCATION_LEVELS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: l, children: l }, l)) })
                ]
              }
            )
          ] }),
          step === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "pj-desc", children: "Brief Description" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                id: "pj-desc",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "AI will expand your description automatically." })
          ] }),
          step === 5 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "pj-loc", children: "Location / Area" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "pj-loc",
          ...
          step === 6 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "pj-phone", children: "Contact Phone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "pj-phone",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between gap-2 pt-2", children: [
          ...
          step < STEPS.length - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            Button,
            {
              ...
              children: create.isPending ? "Posting…" : "Post Job"
            }
          )
        ] })
      ]
...
function ApplyModal({ job, onClose }) {
  ...
  function handleApply() {
    if (!name.trim() || phone.trim().length < 10) {
      ue.error("Please enter your name and a valid phone number.");
      return;
    }
    setSubmitted(true);
    ue.success("Application sent to employer!");
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!job, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm", "data-ocid": "apply-job.dialog", children: [
    ...
    submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-6 h-6 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "Application Submitted!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
            "The employer will contact you at",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: phone })
          ] }),
          job.contactPhone && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
            "Employer:",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: ((_a = job == null ? void 0 : job.location) == null ? void 0 : _a.address) ?? "" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "apply-name", children: "Your Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "apply-name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "apply-phone", children: "Your Phone" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "apply-phone",
...
function JobCard({ job, index, onApply }) {
  ...
  const postedAgo = reactExports.useMemo(() => {
    const diff = Date.now() - Number(job.publishDate) / 1e6;
    const h = Math.floor(diff / 36e5);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "h-full flex flex-col hover:shadow-md transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 pb-3 flex flex-col gap-3 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-sm leading-tight line-clamp-2 flex-1", children: job.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 font-bold text-primary", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px]", children: JOB_TYPE_LABELS[job.jobType] ?? "Daily" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          job.educationLevel && job.educationLevel !== "No requirement" && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-3.5 h-3.5 shrink-0" }),
            "Requires: ",
            job.educationLevel
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: ((_a = job == null ? void 0 : job.location) == null ? void 0 : _a.address) ?? "Location not specified" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
        ...
        job.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground line-clamp-2 leading-relaxed", children: job.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto pt-2 flex items-center justify-between gap-2", children: [
          job.contactPhone && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: `tel:${job.contactPhone}`,
...
function AdminJobFormModal({
  ...
  const [title, setTitle] = reactExports.useState(String((initial == null ? void 0 : initial.title) ?? ""));
  const [category, setCategory] = reactExports.useState(
    String((initial == null ? void 0 : initial.category) ?? ADHOC_ADMIN_CATEGORIES[0])
  );
  const [location, setLocation] = reactExports.useState(
    String(((_a = initial == null ? void 0 : initial.location) == null ? void 0 : _a.address) ?? "")
  );
  const [pricePerDay, setPricePerDay] = reactExports.useState(
    String((initial == null ? void 0 : initial.pricePerDay) ?? (initial == null ? void 0 : initial.budget) ?? "0")
  );
  const [description, setDescription] = reactExports.useState(
    String((initial == null ? void 0 : initial.description) ?? "")
  );
  reactExports.useEffect(() => {
    var _a2;
    if (open) {
      setTitle(String((initial == null ? void 0 : initial.title) ?? ""));
      setCategory(String((initial == null ? void 0 : initial.category) ?? ADHOC_ADMIN_CATEGORIES[0]));
      setLocation(
        String(((_a2 = initial == null ? void 0 : initial.location) == null ? void 0 : _a2.address) ?? "")
      );
      setPricePerDay(String((initial == null ? void 0 : initial.pricePerDay) ?? (initial == null ? void 0 : initial.budget) ?? "0"));
      setDescription(String((initial == null ? void 0 : initial.description) ?? ""));
    }
  }, [open, initial]);
  async function handleSubmit(e) {
    ...
    try {
      ...
      ue.success(isEdit ? "Job updated" : "Job posted successfully!");
      onRefresh();
      onClose();
    } catch (err) {
      ue.error(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", "data-ocid": "admin-job.dialog", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "aj-title", children: "Job Title *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "aj-title",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: category, onValueChange: setCategory, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "admin-job.category.select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select category" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "max-h-56 overflow-y-auto", children: ADHOC_ADMIN_CATEGORIES.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c, children: c }, c)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "aj-price", children: "Pay Rate (₹/day)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "aj-price",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "aj-loc", children: "Location" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              id: "aj-loc",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "aj-desc", children: "Description" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Textarea,
          {
            id: "aj-desc",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 pt-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: createAdmin.isPending ? "Saving…" : isEdit ? "Save Changes" : "Post Job"
          }
        )
      ] })
    ] })
...
function AdminPanel() {
  ...
  async function handleStatusChange(id2, status) {
    try {
      await updateStatus.mutateAsync({ id: id2, status });
  ...
  async function handleDelete(id2) {
    ...
    try {
      await deleteJob.mutateAsync(id2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 p-6", "data-ocid": "adhoc-jobs.admin.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Daily Jobs Admin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: isLoading ? "Loading…" : `${jobs.length} total jobs` })
      ] }),
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "adhoc-jobs.admin.loading_state", children: Array.from({ length: 5 }).map((_, i) => (
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-destructive", children: "Failed to load daily jobs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground max-w-xs text-center", children: error instanceof Error ? error.message : "Could not connect to backend. Ensure the canister is deployed and try again." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No daily/adhoc jobs found. Create the first one using the form below." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/60 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: [
          "Job Title",
          "Category",
          "Location",
          "Pay Rate",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: paged.map((job, idx) => {
          var _a;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-3 font-medium max-w-[160px] truncate", children: job.title }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-3 text-muted-foreground max-w-[120px] truncate", children: ((_a = job.location) == null ? void 0 : _a.address) ?? "—" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-2 px-3 font-medium", children: [
                  "₹",
                  job.pricePerDay ?? 0,
                  "/day"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-3 text-muted-foreground max-w-[100px] truncate", children: job.posterId ?? "admin" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "select",
                  {
                    ...
                    children: JOB_STATUS_OPTIONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: s, children: s }, s))
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-3 text-muted-foreground whitespace-nowrap", children: job.publishDate ? new Date(
                  Number(job.publishDate) / 1e6
...
function AdhocJobsPage() {
  ...
  const [jobTypeFilter, setJobTypeFilter] = reactExports.useState("all");
  const [educationFilter, setEducationFilter] = reactExports.useState("all");
  const [locationFilter, setLocationFilter] = reactExports.useState("");
  const [postModalOpen, setPostModalOpen] = reactExports.useState(false);
  const [applyJob, setApplyJob] = reactExports.useState(null);
  const [lastRefreshed, setLastRefreshed] = reactExports.useState(Date.now());
  const [showFilters, setShowFilters] = reactExports.useState(false);
  const refreshTimerRef = reactExports.useRef(
    void 0
  );
  const { data: backendCategories = [], isLoading: catsLoading } = useAdhocJobCategories();
  const categories = backendCategories.length > 0 ? backendCategories : JOB_CATEGORIES;
  ...
  const {
    ...
    minPrice ? Number(minPrice) : void 0,
    maxPrice ? Number(maxPrice) : void 0,
    locationFilter || void 0
  );
  reactExports.useEffect(() => {
  ...
  const [, tick] = reactExports.useState(0);
  reactExports.useEffect(() => {
    refreshTimerRef.current = setInterval(() => tick((n) => n + 1), 3e4);
    return () => clearInterval(refreshTimerRef.current);
  }, []);
  const refreshedAgo = reactExports.useMemo(() => {
  ...
  const filtered = reactExports.useMemo(() => {
    return jobs.filter((j) => {
      ...
      if (educationFilter !== "all" && (j.educationLevel ?? "No requirement") !== educationFilter)
        return false;
      return true;
    });
  ...
  const hasFilters = !!categoryFilter || !!minPrice || !!maxPrice || jobTypeFilter !== "all" || educationFilter !== "all" || !!locationFilter;
  const totalActive = stats ? Number(stats.totalActive) : filtered.length;
  const popularCategory = stats && stats.categoryBreakdown.length > 0 ? stats.categoryBreakdown.reduce((a, b) => a[1] > b[1] ? a : b)[0] : null;
  const avgPrice = jobs.length > 0 ? Math.round(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "browse", className: "w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 pt-6 pb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold tracking-tight", children: "Daily Jobs" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-0.5", children: [
              "Updated today ·",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: totalActive }),
              " ",
              "jobs available now"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { "data-ocid": "adhoc-jobs.view.tab", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "browse", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-3.5 h-3.5 mr-1.5" }),
              "Browse"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "admin", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-3.5 h-3.5 mr-1.5" }),
              "Admin"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "browse", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6 px-6 pb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
            ...
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-4 h-4 text-amber-500" }),
              label: "Most Popular Category",
              value: jobsLoading ? "—" : popularCategory ?? "—",
              ocid: "adhoc-jobs.stat-popular.card"
            },
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "w-4 h-4 text-green-600" }),
              label: "Avg. Price Today",
              value: jobsLoading ? "—" : avgPrice > 0 ? `₹${avgPrice}` : "—",
              ocid: "adhoc-jobs.stat-avg.card"
            }
          ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { "data-ocid": s.ocid, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-muted flex items-center justify-center", children: s.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: s.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold leading-tight", children: s.value })
            ] })
          ] }) }) }, s.label)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  "Filters",
                  hasFilters && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1.5 w-4 h-4 rounded-full bg-primary text-white text-[9px] flex items-center justify-center font-bold", children: "!" })
                ]
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "ml-auto text-xs text-muted-foreground", children: [
              filtered.length,
              " results"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showFilters && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm", children: "Filter Jobs" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-0 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "max-h-56 overflow-y-auto", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All categories" }),
                            catsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "loading", disabled: true, children: "Loading\\u2026" }) : categories.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c, children: c }, c))
                          ] })
                        ]
                      }
                    )
                      ...
                      Select,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: JobType.oneoff, children: "One-off" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: JobType.adhoc_daily, children: "Daily" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: JobType.adhoc_weekly, children: "Weekly" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: JobType.permanent, children: "Permanent" })
                          ] })
                        ]
                      }
                    )
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "Any education" }),
                            EDUCATION_LEVELS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: l, children: l }, l))
                          ] })
                        ]
                      }
                    )
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Min Price (\\u20b9)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        type: "number",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Max Price (\\u20b9)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        type: "number",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs", children: [
                      "Location",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-muted-foreground", children: "(city / area)" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
          ...
          jobsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: ["s1", "s2", "s3", "s4", "s5", "s6"].map(
            (key, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Card,
              {
                "data-ocid": `adhoc-jobs.loading_state.${i + 1}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 space-y-3", children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold", children: "No jobs found" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: hasFilters ? "Try adjusting your filters or clear them to see all jobs." : "No daily jobs posted yet. Be the first to post one!" }),
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: filtered.map((job, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            JobCard,
            {
              job,
              index: i,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ApplyModal, { job: applyJob, onClose: () => setApplyJob(null) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "admin", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AdminPanel, {}) })
      ] })
    }
  );
}
export {
  AdhocJobsPage as default
};
