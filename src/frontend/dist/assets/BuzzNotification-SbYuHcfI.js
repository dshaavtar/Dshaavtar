import { c as isFunction, F as Dot, Q as findAllByType, X as ErrorBar, j as Layer, e as filterProps, H as Curve, K as Animate, M as interpolateNumber, N as isEqual, I as isNil, Y as hasClipDot, O as LabelList, J as getValueByDataKey, P as uniqueId, G as Global, Z as getCateCoordinateOfLine, g as generateCategoricalChart, f as formatAxisMap } from "./generateCategoricalChart--dgqj_9a.js";
import { cm as React, r as reactExports, j as jsxRuntimeExports } from "./index-D4mmtgjo.js";
...
function BuzzNotification({
  hasNewOrder,
  onAcknowledge
}) {
  const audioCtxRef = reactExports.useRef(null);
  const buzzIntervalRef = reactExports.useRef(null);
  const [pulse, setPulse] = reactExports.useState(false);
  const playBuzz = reactExports.useCallback(() => {
    try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `fixed top-4 right-4 z-50 flex items-center gap-3 bg-destructive text-destructive-foreground rounded-xl px-4 py-3 shadow-elevated transition-all ${pulse ? "animate-pulse" : ""}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 w-2.5 h-2.5 bg-white rounded-full" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-sm tracking-wide uppercase", children: "New Order!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs opacity-90", children: "Tap to acknowledge" })
        ] }),
